...
from lab04_pkg.utils_2 import normalize_angle
...
class RobotEKF:
    ...
    def predict(self, u, sigma_u, g_extra_args=()):
        ...
        # 4. Prepara args COMPLETI per Gt e Vt: [x, y, theta, v, w, dt]
        args = (*self.mu, *u, dt)  # ← Ora ha 8 elementi!

        # 5. Calcola Jacobiane
        Gt = self.eval_Gt(*args)  # ← NON *g_extra_args!
        Vt = self.eval_Vt(*args)  # ← NON *g_extra_args!
